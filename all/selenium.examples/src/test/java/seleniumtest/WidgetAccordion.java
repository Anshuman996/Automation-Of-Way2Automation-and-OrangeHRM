...
public class WidgetAccordion {
	...
	public void AccordionFill() throws InterruptedException
	{
		...
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/h3[4]/span[1]")).click();
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/h3[3]/span[1]")).click();
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/h3[2]/span[1]")).click();
		driver.findElement(By.xpath("/html[1]/body[1]/div[1]/div[1]/h3[1]/span[1]")).click();
	}
	@BeforeMethod
